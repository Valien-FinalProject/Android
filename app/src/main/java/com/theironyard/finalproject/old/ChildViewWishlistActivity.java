...
import com.theironyard.finalproject.activities.CreateWishlistItemActivity;

public class ChildViewWishlistActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_child_view_wishlist);
    }
